...
{
    public class MessageRepository : EfRepository<Messages>, IMessageRepository
    {
        private readonly IDbContextFactory _dbContextFactory;
        private readonly Happy5socialmedia_MessageContext _context;
        public MessageRepository(Happy5socialmedia_MessageContext context, IDbContextFactory dbContextFactory) : base(context)
        {
